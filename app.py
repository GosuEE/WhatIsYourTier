...
client = MongoClient("mongodb+srv://test:sparta@cluster0.ek1pqyw.mongodb.net/Cluster0?retryWrites=true&w=majority", tlsCAFile=ca)
...
def board_write_html():
    return render_template("board_write.html") 바꾸기
@app.route('/')
def home():
